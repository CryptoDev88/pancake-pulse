...
it("renders link correctly", () => {
  const { asFragment } = renderWithProvider(<Link href="https://dextop.pro">Link</Link>);
...
it("renders link external link correctly", () => {
  const { asFragment } = renderWithProvider(<LinkExternal href="https://dextop.pro">Link</LinkExternal>);
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      .c2 {
