...
export const TokenImages: React.FC<React.PropsWithChildren> = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://dextop.pro/images/tokens/${token.address[56]}.png`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://dextop.pro/images/tokens/${token.address[56]}.png`;
        const secondarySrc = `https://dextop.pro/images/tokens/${tokens[randomTokenIndex].address[56]}.png`;
