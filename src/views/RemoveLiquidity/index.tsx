  ...
  const handleSelectCurrencyA = useCallback(
    (currency: Currency) => {
      if (currencyIdB && currencyId(currency) === currencyIdB) {
        router.pathname.replace(`/remove/${currencyId(currency)}/${currencyIdA}`, undefined)
      } else {
        router.pathname.replace(`/remove/${currencyId(currency)}/${currencyIdB}`, undefined)
      }
    },
  ...
  const handleSelectCurrencyB = useCallback(
    (currency: Currency) => {
      if (currencyIdA && currencyId(currency) === currencyIdA) {
        router.pathname.replace(`/remove/${currencyIdB}/${currencyId(currency)}`, undefined)
      } else {
        router.pathname.replace(`/remove/${currencyIdA}/${currencyId(currency)}`, undefined)
      }
    },
    [currencyIdA, currencyIdB, router],
  )
