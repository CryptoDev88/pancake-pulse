...
describe('isTradeBetter', () => {
  const token1 = new Token(ChainId.BSC, '0x0000000000000000000000000000000000000001', 18, "K1")
  const token2 = new Token(ChainId.BSC, '0x0000000000000000000000000000000000000002', 18, "k2")
  const token3 = new Token(ChainId.BSC, '0x0000000000000000000000000000000000000003', 18, "k3")
