...
export const transformBetResponse = (tokenSymbol) =>
  tokenSymbol === 'DEX' ? transformBetResponseCAKE : transformBetResponseBNB

export const transformUserResponse = (tokenSymbol) =>
  tokenSymbol === 'DEX' ? transformUserResponseCAKE : transformUserResponseBNB
...
export const getTotalWon = async (): Promise<{ totalWonBNB: number; totalWonCAKE: number }> => {
  ...
  const totalWonCAKE = getTotalWonMarket(CAKEMarket, 'DEX')
