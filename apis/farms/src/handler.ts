...
import { BUSD, DEX } from '@pancakeswap/tokens'
...
const cakeBusdPairMap = {
  [ChainId.BSC]: {
    address: Pair.getAddress(DEX[ChainId.BSC], BUSD[ChainId.BSC]),
    tokenA: DEX[ChainId.BSC],
    tokenB: BUSD[ChainId.BSC],
  },
  [ChainId.BSC_TESTNET]: {
    address: Pair.getAddress(DEX[ChainId.BSC_TESTNET], BUSD[ChainId.BSC_TESTNET]),
    tokenA: DEX[ChainId.BSC_TESTNET],
